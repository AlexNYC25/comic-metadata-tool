...
import { getZipContentList, getZipComment } from './zip-utils.js';
import { getRarContentList, getRarComment } from './rar-utils.js';
import { get7zContentList } from './7z-utils.js';
...
export async function getArchiveContentList(filePath) {
...
export async function getArchiveComment(filePath) {
    const archiveType = getArchiveType(filePath);
    let comment = '';
    switch (archiveType) {
        case 'zip':
