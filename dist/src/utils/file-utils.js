...
function getArchiveContentList(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        const archiveType = getArchiveType(filePath);
        let contentList = [];
        switch (archiveType) {
            case 'zip':
                contentList = yield (0, zip_utils_1.getZipContentList)(filePath);
                break;
            case 'rar':
                contentList = yield (0, rar_utils_1.getRarContentList)(filePath);
                break;
            case '7z':
                contentList = yield (0, _7z_utils_1.get7zContentList)(filePath);
                break;
            default:
...
function getArchiveComment(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        const archiveType = getArchiveType(filePath);
        let comment = '';
        switch (archiveType) {
            case 'zip':
                comment = yield (0, zip_utils_1.getZipComment)(filePath);
                break;
            case 'rar':
                comment = yield (0, rar_utils_1.getRarComment)(filePath);
                break;
            case '7z':
