 ...
 */
export function convertParsedXmlToComicInfo(parsedXmlData) {
    ...
    return {
        ...
        penciler: comicInfoData.Penciler,
 ...
 */
export function convertParsedXmlToCoMet(parsedXmlData) {
    ...
    return {
        ...
        penciler: ensureArray(cometData.penciler),
 ...
 */
export function convertParsedArchiveCommentToComicbookinfo(parsedJsonData) {
